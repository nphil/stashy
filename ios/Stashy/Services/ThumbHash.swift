// ThumbHash — Copyright (c) 2023 Evan Wallace — MIT License
// Ported verbatim from https://github.com/evanw/thumbhash (swift/ThumbHash.swift).
//
// NOTE: the non-idiomatic `while` loops and split-up expressions below are DELIBERATE — the upstream
// author uses them to dodge Swift's exponential type-checker and slow debug-build `for-in` (measured
// ~10x wins). Do NOT "clean them up"; CI is our only compiler.
